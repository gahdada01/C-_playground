...
namespace WindowsFormsApplication1
{
    class Client
    {
        ...
        public Client(int _id, string _cocno, string _firstname, string _middlename, string _lastname, string _dateReceived, string _street, string _barangay, string _city, int _zipcode, string _company, string _position, string _gender, string _civilstatus, string _bloodtype, string _group, double _amount, bool _status, string _birthdate, string _mobile, string _phone, int _units) // constructor overloading
        {
            id = _id;
