...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void btn_Edit_Click(object sender, EventArgs e)
        {
            ...
            Form f2 = new Form2(id, zipcode, cocno, firstname, middlename, lastname, street, barangay, city, company, position, group, phone, mobile, units, amount, gender, status, bloodtype, civilstatus/*,dateReceived*/, birthdate);
            f2.ShowDialog();
        }
        ...
        private void dgv_ClientInfo_MouseClick(object sender, MouseEventArgs e)
        {
            try
            {
                ...
                btn_VBeneficiaries.Enabled = true;
            ...
            catch
            {
                ...
                btn_VBeneficiaries.Enabled = false;
